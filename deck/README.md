...
one white accent, and the pixel-art house from [`../site/assets/house-mascot.svg`](../site/assets/house-mascot.svg).
...
- **Motif** — the pixel-art house (grayscale, from `../site/assets/house-mascot.svg`) recurs on the
