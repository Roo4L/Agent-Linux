# Requirements Archive: v0.1.0 AgentLinux Landing Page
...
- [x] **MAIL-01**: Email signup form integrated with Buttondown API

### FAQ

- [x] **FAQ-01**: FAQ section with common questions about AgentLinux

### Design

- [x] **DSGN-01**: Terminal/hacker aesthetic — dark theme, monospace fonts, CLI visual style
- [x] **DSGN-02**: Responsive design (mobile + desktop)
- [x] **DSGN-03**: Static HTML/CSS/JS — no build step, no framework

### Footer

- [x] **FOOT-01**: Footer with copyright and basic links
