...
|--------|----------------------------|
| **A / C** | `product/plugin/catalog/agents/<name>/agent.json` (10-20 lines) + `install.sh` (20-40 lines) + `uninstall.sh` (symmetric) + PR. JSON Schema validates entry. CI runs bats install+run+uninstall. |
