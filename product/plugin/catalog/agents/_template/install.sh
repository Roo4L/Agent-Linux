...
#      mcp     : source "${AGENTLINUX_CATALOG_DIR}/lib/mcp-register.sh"
#                al_mcp_install_http <server> <url> "<display name>"
#                — the whole hosted-MCP install arc (announce, fan out to every
#                  present agent, diagnose failure). Add only your vendor's auth
#                  NOTE after it. Do NOT hand-roll around al_mcp_register_http.
